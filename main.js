...
__export(main_exports, {
  default: () => DiffusionGrammarPlugin
});
...
var DiffusionGrammarPlugin = class extends import_obsidian.Plugin {
  constructor() {
    super(...arguments);
    __publicField(this, "settings");
    __publicField(this, "openai", null);
  ...
  async onload() {
    ...
    this.statusBarItem.onClickEvent(() => {
      ...
      this.saveSettings();
      this.updateStatusBar();
      new import_obsidian.Notice(`Auto-correct ${this.settings.enableAutoCorrect ? "enabled" : "disabled"}`);
    });
    this.registerEvent(
  ...
  async correctParagraph(editor, lineNumber, text) {
    var _a3, _b, _c;
    if (!this.openai) {
    ...
    try {
      ...
      const correctedText = (_c = (_b = (_a3 = response.choices[0]) == null ? void 0 : _a3.message) == null ? void 0 : _b.content) == null ? void 0 : _c.trim();
      if (correctedText && correctedText !== text) {
        editor.setLine(lineNumber, correctedText);
      }
    } catch (error) {
      console.error("Error correcting text:", error);
      new import_obsidian.Notice("Failed to correct text: " + error.message);
    } finally {
  ...
  getLineElement(editor, lineNumber) {
    var _a3;
    ...
    return (_a3 = lineDOM == null ? void 0 : lineDOM.node) == null ? void 0 : _a3.parentElement;
  }
  updateStatusBar() {
...
var DiffusionGrammarSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("API Key").setDesc("Enter your Inception Labs API key").addText((text) => text.setPlaceholder("sk_...").setValue(this.plugin.settings.apiKey).onChange(async (value) => {
      this.plugin.settings.apiKey = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("Enable Auto-Correct").setDesc("Automatically correct paragraphs when pressing Enter").addToggle((toggle) => toggle.setValue(this.plugin.settings.enableAutoCorrect).onChange(async (value) => {
      this.plugin.settings.enableAutoCorrect = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian.Setting(containerEl).setName("System Prompt").setDesc("Customize the instructions given to the AI model").addTextArea((text) => text.setPlaceholder("Enter system prompt...").setValue(this.plugin.settings.systemPrompt).onChange(async (value) => {
